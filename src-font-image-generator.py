...
DEFAULT_TARGET_FONTS_DIR = os.path.join(SCRIPT_PATH, 'fonts/tgt_font')
DEFAULT_SOURCE_FONTS_DIR = os.path.join(SCRIPT_PATH, 'fonts/src_font')
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, 'src-image-data')

# Width and height of the resulting image.
IMAGE_WIDTH = 256
IMAGE_HEIGHT = 256

def generate_hangul_images(label_file, target_fonts_dir, src_fonts_dir, output_dir):
...
if __name__ == '__main__':
    ...
    generate_hangul_images(args.label_file, args.target_fonts_dir, args.src_fonts_dir, args.output_dir)