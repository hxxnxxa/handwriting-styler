...
def main():
    ...
    model = create_model(examples.src_font, examples.trg_font, examples.style_labels, args)
    ...
    with tf.name_scope("encode_images"):
        display_fetches = {
            ...
            "trg_font": tf.map_fn(tf.image.encode_png, converted_trg_font, dtype=tf.string, name="input_pngs"),
