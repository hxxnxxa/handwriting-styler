...
Examples = collections.namedtuple("Examples", "paths, src_font, trg_font, count, steps_per_epoch, style_labels")
...
def _parse_function(example, a):
    ...
    return src_font, trg_font, style_label, path
...
def load_examples(args):
   ...
   # batch contains the input images , labels and target images for the model
    src_font, trg_font, style_label, path = batch
